...
export const container: React.CSSProperties = { width: "100%", maxWidth: "600px", margin: "24px auto", borderTop: `2px solid ${colors.green}`, borderRadius: "2px", backgroundColor: colors.paper };
...
export const h1: React.CSSProperties = { margin: "0 0 14px", color: colors.ink, fontFamily: "Georgia, Times New Roman, serif", fontWeight: 400, fontSize: "34px", lineHeight: "40px", letterSpacing: "-0.6px" };
...
export const pulseSection: React.CSSProperties = { width: "100%", backgroundColor: colors.greenSoft, borderRadius: "2px" };
...
export const pulseBasis: React.CSSProperties = { margin: 0, color: colors.muted, fontSize: "12px", lineHeight: "18px" };
...
export const heroImage: React.CSSProperties = { display: "block", margin: "0 auto", maxWidth: "100%", height: "auto", borderRadius: "2px" };
...
export const bannerImage: React.CSSProperties = { display: "block", width: "100%", height: "auto", borderRadius: "2px" };
...
export const credit: React.CSSProperties = { margin: "6px 0 18px", color: "#78847f", fontSize: "12px", lineHeight: "18px" };
...
export const keyPointBox: React.CSSProperties = { margin: "0 0 18px", padding: "16px 18px", backgroundColor: colors.warm, borderRadius: "2px" };
...
export const primaryButton: React.CSSProperties = { backgroundColor: colors.green, borderRadius: "2px", color: "#ffffff", display: "inline-block", fontSize: "14px", fontWeight: 700, padding: "14px 20px", textDecoration: "none" };
...
export const footerText: React.CSSProperties = { margin: 0, color: colors.muted, fontSize: "12px", lineHeight: "19px" };
